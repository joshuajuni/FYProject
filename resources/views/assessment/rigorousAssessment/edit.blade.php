...
@section('title', 'EDIT REPORT OF RIGOROUS ASSESSMENT')

@section('content')

<div class="container-fluid">
    <h3 class="text-dark mb-4">EDIT REPORT OF RIGOROUS ASSESSMENT</h3>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('assessment.update', $assessment) }}">
            @csrf
                <div class="mb-3">
        ...
        <div class="card-body">
            <ul class="list-group list-group-flush">
                ...
                <textarea class="ckeditor form-control" id="B1comments" name="B1comments" required>{!! $assessment->data->B1comments !!}</textarea>
                </li>
            </ul>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                ...
                <textarea class="ckeditor form-control" id="B2comments" name="B2comments" required>{!! $assessment->data->B2comments !!}</textarea>
                </li>
            </ul>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                ...
                <textarea class="ckeditor form-control" id="B3comments" name="B3comments" required>{!! $assessment->data->B3comments !!}</textarea>
                </li>
            </ul>   
        </div>
        <div class="card-header py-3">
        ...
        <div class="card-body">
            <ul class="list-group list-group-flush">
                ...
                <textarea class="ckeditor form-control" id="C1comments" name="C1comments" required>{!! $assessment->data->C1comments !!}</textarea>
                </li>
            </ul> 
        </div>
