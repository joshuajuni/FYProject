...
@section('title', 'REPORT OF RIGOROUS ASSESSMENT')

@section('content')

<div class="container-fluid">
    <h3 class="text-dark mb-4">REPORT OF RIGOROUS ASSESSMENT</h3>
        ...
        <div class="card-body">
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="" name="" value="{{ $session->proposal_title }}" disabled>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="">
                        <strong>Potential Supervisor</strong>
                    </label>
                    <input class="form-control" type="text" id="" name="" value="{{ $session->student->supervisor->profile->name}}" disabled>
                </div>
        </div>
        <div class="card-header py-3">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1I" id="B1I" value="1" required>
                            <label class="form-check-label" for="B1I">Arguments are not clear/incorrect</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1I" id="B1I" value="2" required>
                            <label class="form-check-label" for="B1I">Arguments are partially clear and need to be refined</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1I" id="B1I" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1II" id="B1II" value="1" required>
                            <label class="form-check-label" for="B1II">Problem statements are not clearly stated</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1II" id="B1II" value="2" required>
                            <label class="form-check-label" for="B1II">Problem statements are adequate but need to be refined</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1II" id="B1II" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1III" id="B1III" value="1" required>
                            <label class="form-check-label" for="B1III">Objectives are not clearly defined</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1III" id="B1III" value="2" required>
                            <label class="form-check-label" for="B1III">Objectives are clear but need to be refined</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1III" id="B1III" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1IV" id="B1IV" value="1" required>
                        ...
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1IV" id="B1IV" value="2" required>
                            <label class="form-check-label" for="B1IV">Reflects understanding of subject matter and related literature</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1IV" id="B1IV" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1V" id="B1V" value="1" required>
                            <label class="form-check-label" for="B1V">Demonstrates an elementary understanding of theoretical concepts</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1V" id="B1V" value="2" required>
                            <label class="form-check-label" for="B1V">Demonstrates an adequate knowledge of theoretical concepts</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1V" id="B1V" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1VI" id="B1VI" value="1" required>
                            <label class="form-check-label" for="B1VI">The methodology is unorganised and lack of explanation</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1VI" id="B1VI" value="2" required>
                            <label class="form-check-label" for="B1VI">The methodology is adequately explained</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B1VI" id="B1VI" value="3" required>
                ...
                <textarea class="ckeditor form-control" id="B1comments" name="B1comments" required></textarea>
                </li>
            </ul>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2I" id="B2I" value="1" required>
                            <label class="form-check-label" for="B2I">Writing is weak</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2I" id="B2I" value="2" required>
                            <label class="form-check-label" for="B2I">Writing is adequate</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2I" id="B2I" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2II" id="B2II" value="1" required>
                            <label class="form-check-label" for="B2II">Numerous grammatical and spelling errors apparent</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2II" id="B2II" value="2" required>
                            <label class="form-check-label" for="B2II">Some grammatical and spelling errors apparent</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2II" id="B2II" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2III" id="B2III" value="1" required>
                            <label class="form-check-label" for="B2III">Organisation is poor</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2III" id="B2III" value="2" required>
                            <label class="form-check-label" for="B2III">Organisation is logical</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2III" id="B2III" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2IV" id="B2IV" value="1" required>
                            <label class="form-check-label" for="B2IV">Reference format is problematic</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2IV" id="B2IV" value="2" required>
                            <label class="form-check-label" for="B2IV">Reference contains few formatting errors</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="B2IV" id="B2IV" value="3" required>
                ...
                <textarea class="ckeditor form-control" id="B2comments" name="B2comments" required></textarea>
                </li>
            </ul>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                ...
                <textarea class="ckeditor form-control" id="B3comments" name="B3comments" required></textarea>
                </li>
            </ul>   
        </div>
        <div class="card-header py-3">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1I" id="C1I" value="1" required>
                            <label class="form-check-label" for="C1I">Presentation unacceptable</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1I" id="C1I" value="2" required>
                            <label class="form-check-label" for="C1I">Presentation acceptable</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1I" id="C1I" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1III" id="C1III" value="1" required>
                        ...
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1III" id="C1III" value="2" required>
                            <label class="form-check-label" for="C1III">The presentation reveals some depth of knowledge in the subject matter</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1III" id="C1III" value="3" required>
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1IV" id="C1IV" value="1" required>
                            <label class="form-check-label" for="C1IV">Responses to questions are incomplete</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1IV" id="C1IV" value="2" required>
                            <label class="form-check-label" for="C1IV">Responses to questions are partially complete and require assistance</label>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="C1IV" id="C1IV" value="3" required>
                ...
                <textarea class="ckeditor form-control" id="C1comments" name="C1comments" required></textarea>
                </li>
            </ul> 
        </div>
