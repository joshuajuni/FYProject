...
<div class="container-fluid">
    <h3 class="text-dark mb-4">Create Assessment</h3>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="A1" id="A1" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="A2" id="A2" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="A3" id="A3" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="A4" id="A4" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="A5" id="A5" value="{{ $i }}" required>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B1" id="B1" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B2" id="B2" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B3" id="B3" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B4" id="B4" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B5" id="B5" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B6" id="B6" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="B7" id="B7" value="{{ $i }}" required>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="C1" id="C1" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                     @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="C2" id="C2" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                     @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="C3" id="C3" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="C4" id="C4" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                     @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="C5" id="C5" value="{{ $i }}" required>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="D1" id="D1" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="D2" id="D2" value="{{ $i }}" required>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 text-center">
                    @for ($i = 5; $i >= 1; $i--)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="D3" id="D3" value="{{ $i }}" required>
